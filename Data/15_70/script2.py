...
# file_ginny = open("26_ginny.csv",'w')
...
file_ginny = open("avg_ginny.csv",'w')
...
for x in range(0,101):		# set range(1,100)
	...
	for j in range(100):		# set range(100)
		z = subprocess.check_output(["python", "algo2a.py", str(supern), str(lower), str(x), str(100-x), str(start_nodes[j]) ])
		y = z.split()
		if int(y[0])==1 :
